...
namespace NBA_Schedule_Request
{
    ...
    {
        public IList<NationalTvBroadcaster> nationalTvBroadcasters { get; set; }
        public IList<NationalRadioBroadcaster> nationalRadioBroadcasters { get; set; }
        public IList<HomeTvBroadcaster> homeTvBroadcasters { get; set; }
        public IList<HomeRadioBroadcaster> homeRadioBroadcasters { get; set; }
        public IList<AwayTvBroadcaster> awayTvBroadcasters { get; set; }
        public IList<AwayRadioBroadcaster> awayRadioBroadcasters { get; set; }
        public IList<object> intlRadioBroadcasters { get; set; }
        public IList<object> intlTvBroadcasters { get; set; }
    }
    */
    ...
    public class Game
    {
        ...
        public IList<PointsLeader> pointsLeaders { get; set; }
    }
